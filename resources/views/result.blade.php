...
<div class="card mb-12  search-box " style="background: #4a9bc4; color:white;">
        ...
        <input type="text" name="cep_origem"  class="form-control" value="{{$cep_origem}}" placeholder="Cep de Origem:">
        </div>
        <br>
        <br>
        <br>
        <div class="input-field col s2">
        <input type="text" name="cep_destino"  class="form-control" value="{{$cep_destino}}" placeholder="Cep de Destino:" >
        </div>
        </div>
        <div class="row vaing-wrapper">
          <div class="input-field col s3">
          <input type="text" name="peso"  class="form-control" value="{{$peso}}" placeholder="Peso:" >
        </div>
        <br>
...
<div class="col-11.3">
        ...
        <div class="card" style="background: #4a9bc4; color:white;">
        <div class="card-body">
           <table  class="table table-hover" style="background: #4a9bc4; color:white;"> 
           <thead>
                <tr class="" style="background: #4a9bc4; color:white;">
                    <th>   Servico </th>
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td>  {{$rst->nm_servico}}              </td> 
                     <td>    {{$rst->nm_transportadora}}      </td>
                     <td>    {{$rst->prazo_entrega}}  dias úteis   </td>
                     <td>  {{$rst->valor}} </td>
